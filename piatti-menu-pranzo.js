...
let TOP_PIATTI = {
  ...
  "mix di verdure lessate": {categoria:"contorno", regione:"Italia", iconico:false, top:false, selezione:true, punteggio:3, sinonimi:["verdure bollite"], allergeni:[], dieta:"vegetariano"}
};
